...
final class SystemServiceRegistry {
	...
	registerService("sound",SoundManager.class,  
		new CachedServiceFetcher<SoundManager>(){  
		@Override   
		public SoundManager createService(ContextImpl ctx)  
		{  
			IBinder b = ServiceManager.getService("sound"); 			 
			return new SoundManager(ctx,ISoundService.Stub.asInterface(b));  
	        }});  
